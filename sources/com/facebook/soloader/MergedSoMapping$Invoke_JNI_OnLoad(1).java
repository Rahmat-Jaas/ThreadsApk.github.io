...
public class MergedSoMapping$Invoke_JNI_OnLoad {
    public static native int libInstagramDasmConfigCreator_jni_so();
    ...
    public static native int libarfx_engine_plugin_touchgestures_so();

    public static native int libarpersistenceservice_so();

    public static native int libarthook_so();
    ...
    public static native int libcomfacebookmillsearchsdkdirectsqlnativeopsjni_so();

    public static native int libcomfacebookmillshimaddressabletransportsbasedirectsqlnativeopsjni_so();

    public static native int libcomfacebookmillstaxthreadthemecqlinterfacecqlbundledirectsqlnativeopsjni_so();

    public static native int libcomfacebookmilltamparticipantlistbasedirectsqlnativeopsjni_so();
    ...
    public static native int libcryptocontextholder_so();
    ...
    public static native int libfbexit_so();
    ...
    public static native int libgans_ops_xplat_so();

    public static native int libglcommon_so();

    public static native int libgltfholdernew_so();

    public static native int libgraphbase_so();

    public static native int libgraphicsengine_arengineservices_igeffectservicehost_native_so();

    public static native int libgraphqllivequeries_sdk_provider_jni_instagram_so();
    ...
    public static native int libig_distribgw_jni_so();

    public static native int libigcollaborativeapp_jni_so();

    public static native int libigrequeststream_dgw_jni_so();

    public static native int libigrequeststream_jni_so();

    public static native int libigrtcjni_so();

    public static native int libigtigon_jni_so();

    public static native int libinstagramDatabaseRedactor_jni_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMS_DEFERRED_acg_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMS_DEFERRED_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMS_DEFERREDnovt_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMS_acg_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMS_so();

    public static native int libinstagramDatabaseSchemaDeployerMDMSnovt_so();

    public static native int libinstagramDatabaseSchemaDeployer_acg_so();

    public static native int libinstagramDatabaseSchemaDeployer_jniMDMS_DEFERRED_so();

    public static native int libinstagramDatabaseSchemaDeployer_jniMDMS_DEFERREDnovt_so();

    public static native int libinstagramDatabaseSchemaDeployer_jniMDMS_so();

    public static native int libinstagramDatabaseSchemaDeployer_jniMDMSnovt_so();

    public static native int libinstagramDatabaseSchemaDeployer_jni_so();

    public static native int libinstagramDatabaseSchemaDeployer_jninovt_so();

    public static native int libinstagramDatabaseSchemaDeployer_so();

    public static native int libinstagramDatabaseSchemaDeployernovt_so();

    public static native int libinstagramTableToCqlProcRegistration_jni_so();

    public static native int libinstagram_libeffectservicehostmerged_so();

    public static native int libinstagram_libliger_so();

    public static native int libinstagram_libmodelcache_so();

    public static native int libinstagram_libxplat_arfx_graphics_engineAndroid_so();

    public static native int libjavamemtracking500_so();

    public static native int libjavamemtracking511_so();

    public static native int libjavamemtracking601_so();

    public static native int libjavamemtracking700_so();

    public static native int libjavamemtracking712_so();
    ...
    public static native int libjpegutils_moz_so();
    ...
    public static native int libmailboxadvancedcryptotestmessagesendjni_so();
    ...
    public static native int libmailboxinstagramopenxmareceiverfetchjni_so();

    public static native int libmailboxinstagrampresencejni_so();

    public static native int libmailboxinstagramsearchjni_so();

    public static native int libmailboxinstagramsecuremessagejni_so();

    public static native int libmailboxinstagramuserjni_so();
    ...
    public static native int libmailboxsecureconsentframeworkjni_so();
    ...
    public static native int libmailboxtamreportingshimjni_so();
    ...
    public static native int libmailboxurlblackholejni_so();
    ...
    public static native int libmediapipeline_iglufilter_instagram_so();

    public static native int libmediastreaming_bundledservices_so();

    public static native int libmediastreaming_config_so();

    public static native int libmediastreaming_devicehealthmonitor_so();
    ...
    public static native int libmessengerarmadilloinstagram_jni_so();
    ...
    public static native int libpando_graphql_instagram_jni_so();
    ...
    public static native int libpando_subscription_service_so();
    ...
    public static native int libprofilo_memory_mapping_actions_so();
    ...
    public static native int libprofilo_native_memory_so();
    ...
    public static native int librecognitionservice_so();
    ...
    public static native int librsysappstatejni_so();
    ...
    public static native int librsysconnectfunneljni_so();

    public static native int librsyscowatchjni_so();
    ...
    public static native int librsysgridjni_so();

    public static native int librsysgroupexpansionjni_so();

    public static native int librsysgroupexpansionmsysjni_so();

    public static native int librsyslivevideojni_so();
    ...
    public static native int librsysmoderatorjni_so();

    public static native int librsysmosaicgridjni_so();
    ...
    public static native int librsysreactionsjni_so();

    public static native int librsysroomsjni_so();

    public static native int librsysroomslobbyjni_so();
    ...
    public static native int librsysvideoeffectcommunicationjni_so();
    ...
    public static native int libscrambler_so();

    public static native int libsecurethreadlistchildresultsetutils_so();

    public static native int libsimplejni_so();

    public static native int libsingle_model_cache_native_android_so();

    public static native int libslamfactoryprovider_so();
    ...
    public static native int libtarget_recognition_android_so();

    public static native int libtigonjni_so();

    public static native int libtigonligerlite_jni_so();

    public static native int libtigonmns_jni_so();
    ...
    public static native int libunifiedfilter_so();

    public static native int libverifier1000_so();

    public static native int libverifier1100_so();

    public static native int libverifier601_so();

    public static native int libverifier700_so();

    public static native int libverifier712_so();

    public static native int libverifier800_so();

    public static native int libverifier810_so();

    public static native int libverifier900_so();
    ...
    public static native int libxplat_mantle_apps_instagram_mantle_helperAndroid_so();
