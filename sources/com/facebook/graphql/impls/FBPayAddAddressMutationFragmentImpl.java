...
public final class FBPayAddAddressMutationFragmentImpl extends TreeJNI implements C81204nM {

    public final class PayAddMailingAddress extends TreeJNI implements C81204nM {
    ...
    public final C108776iv[] getEdgeFields() {
        return AnonymousClass0wJ.A1a(PayAddMailingAddress.class, "pay_add_mailing_address(data:$data)");
    }
}
