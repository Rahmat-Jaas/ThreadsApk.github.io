...
public class DexUnpacker {
    ...
    public List copySecondaryDexes(File file) {
        CopyDexIterator copySecondaryDexIterator = getCopySecondaryDexIterator(file, (LightweightQuickPerformanceLogger) null);
        try {
    ...
    public CopyDexIterator getCopySecondaryDexIterator(File file) {
        return getCopySecondaryDexIterator(file, (LightweightQuickPerformanceLogger) null);
    }
