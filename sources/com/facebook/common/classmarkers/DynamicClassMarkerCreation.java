...
public final class DynamicClassMarkerCreation {
    ...
    public static void generateClassLoadMarkerEnd(String str, String str2) {
        ...
        if (IS_SUPPORTED && (currentNumForClass = getCurrentNumForClass(AnonymousClass00U.A0L(str, START_MARKER))) != -1) {
            int currentNumForClass2 = getCurrentNumForClass(AnonymousClass00U.A0L(str, END_MARKER));
    ...
    public static void commonGenerateClassLoadMarker(String str, String str2, String str3) {
        String A0L = AnonymousClass00U.A0L(str, str2);
