...
public final class SmbToolsFragment$onCreateView$1 extends C02220Ah implements AnonymousClass0YP {
    public final /* synthetic */ SmbToolsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SmbToolsFragment$onCreateView$1(SmbToolsFragment smbToolsFragment) {
        super(2);
    ...
    public final void invoke(C147188nY r15, int i) {
        ...
        if ((i & 11) != 2 || !r15.BCM()) {
            ...
            final SmbToolsFragment smbToolsFragment = this.this$0;
            AnonymousClass70T.A01((AnonymousClass79L) null, r4, (Modifier) null, (C142918fo) null, AnonymousClass7JR.A00(r15, new AnonymousClass0YP() {
                public final void invoke(C147188nY r3, int i) {
                    if ((i & 11) != 2 || !r3.BCM()) {
                        SmbToolsFragment.this.BuildDebugOptionList(r3, 8);
                    } else {
                        r3.CuJ();
                    }
                }
