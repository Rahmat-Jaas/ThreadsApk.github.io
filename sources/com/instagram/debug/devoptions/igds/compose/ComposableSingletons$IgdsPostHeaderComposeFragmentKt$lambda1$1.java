...
public final class ComposableSingletons$IgdsPostHeaderComposeFragmentKt$lambda1$1 extends C02220Ah implements AnonymousClass0YP {
    ...
    public final void invoke(C147188nY r3, int i) {
        if ((i & 11) != 2 || !r3.BCM()) {
            IgdsPostHeaderComposeFragmentKt.IgdsPostHeaderExamples(r3, 0);
        } else {
            r3.CuJ();
        }
    }
