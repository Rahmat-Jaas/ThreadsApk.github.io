...
public final class CXPCommentHideMutationResponseImpl extends TreeJNI implements C81204nM {

    public final class XcxpDispatchCommentHide extends TreeJNI implements C81204nM {
    ...
    public final C108776iv[] getEdgeFields() {
        return AnonymousClass0wJ.A1b(XcxpDispatchCommentHide.class, "xcxp_dispatch_comment_hide(destinations:[$destination],params:$params)");
    }
}
