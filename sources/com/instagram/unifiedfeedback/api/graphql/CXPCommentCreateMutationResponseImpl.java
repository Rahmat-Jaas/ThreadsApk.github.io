...
public final class CXPCommentCreateMutationResponseImpl extends TreeJNI implements C81204nM {

    public final class XcxpDispatchCommentCreate extends TreeJNI implements C81204nM {
    ...
    public final C108776iv[] getEdgeFields() {
        return AnonymousClass0wJ.A1b(XcxpDispatchCommentCreate.class, "xcxp_dispatch_comment_create(destinations:[$destination],params:$params)");
    }
}
