...
public enum IGTVNotificationCenterItemType implements Parcelable {
    ...
    static {
        ...
        for (IGTVNotificationCenterItemType iGTVNotificationCenterItemType : values()) {
            A0v.put(iGTVNotificationCenterItemType.A00, iGTVNotificationCenterItemType);
        }
        A01 = A0v;
        CREATOR = new PCreatorCreatorShape12S0000000_I2_12(91);
    }
