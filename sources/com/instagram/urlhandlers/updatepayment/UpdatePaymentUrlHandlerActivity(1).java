...
public class UpdatePaymentUrlHandlerActivity extends BaseFragmentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        int A002 = C14030oh.A00(1059763919);
        super.onCreate(bundle);
        Intent intent = getIntent();
        C10300i6 A0S = C18190wL.A0S(C18210wN.A0B(intent));
        this.A00 = A0S;
        ...
        C63743iE A022 = C63743iE.A02("com.bloks.www.bloks.commerce.checkout.update_payment_method", A0y);
        IgBloksScreenConfig A0N = C18190wL.A0N(A02);
        C18210wN.A0s(this, A0N, 2131837437);
        A0N.A0h = true;
        C18220wO.A1B(C62853b1.A02(A0N, A022), A0Q, false);
        C14030oh.A07(-172755301, A002);
    }
}
