...
public final class ViewAllLeadOpportunitiesUrlHandlerActivity extends BaseFragmentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        int i;
        Bundle A0B;
        int A00 = C14030oh.A00(-1909464416);
        ...
        if (intent == null || (A0B = C18210wN.A0B(intent)) == null) {
            ...
            if (A0i == null || A0i.length() == 0) {
                ...
                if (!(getSession() instanceof UserSession)) {
                    ...
                    AnonymousClass0wJ.A19(C62853b1.A03(session, "com.bloks.www.ig.smb.lead_gen.all_lead_opportunities", C25731Dqw.A00(A01)), this, session);
                }
            }
            i = -787522391;
        }
