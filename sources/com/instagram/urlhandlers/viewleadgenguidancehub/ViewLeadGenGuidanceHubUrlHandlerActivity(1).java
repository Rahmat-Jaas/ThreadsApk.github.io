...
public final class ViewLeadGenGuidanceHubUrlHandlerActivity extends BaseFragmentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        int i;
        Bundle A0B;
        int A00 = C14030oh.A00(-1247771254);
        ...
        if (intent == null || (A0B = C18210wN.A0B(intent)) == null) {
            ...
            if (A0i == null || A0i.length() == 0) {
                ...
                if (!(getSession() instanceof UserSession)) {
                    ...
                    HashMap A002 = C25731Dqw.A00(A01);
                    C18210wN.A0w(A01, "entry_point", A002);
                    AnonymousClass0wJ.A19(C62853b1.A03(session, "com.bloks.www.ig.smb.lead_gen.lead_gen_guide", A002), this, session);
                }
            }
            i = -974507575;
        }
