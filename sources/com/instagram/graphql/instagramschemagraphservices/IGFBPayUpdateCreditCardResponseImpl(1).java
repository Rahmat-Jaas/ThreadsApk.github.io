...
public final class IGFBPayUpdateCreditCardResponseImpl extends TreeJNI implements C81204nM {

    public final class UpdateCreditCard extends TreeJNI implements C81204nM {
    ...
    public final C108776iv[] getEdgeFields() {
        return AnonymousClass0wJ.A1a(UpdateCreditCard.class, "update_credit_card(data:$input)");
    }
}
