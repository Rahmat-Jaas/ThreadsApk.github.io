...
public class StoryBackgroundPrefetchJobService extends BackgroundPrefetchJobService {
    ...
    public final void A02() {
        ...
        if ((A0W instanceof UserSession) && C691847d.A05()) {
            ...
            if (C63803iN.A0E(AnonymousClass0TJ.A05, A0W, 36320833321244948L)) {
                C28161tl A01 = AnonymousClass3WS.A01(A02);
                C04220Ms.A0B(A01, 1);
                List A00 = C34382Ji.A00(A01);
                C04220Ms.A0B(A00, 0);
        ...
        if (longValue > 0) {
            Class<?> cls = getClass();
            C04220Ms.A0B(cls, 2);
            C25666Dpn.A00(C10600ic.A00).A02(new C25425DlP(cls, R.id.story_background_prefetch_job_scheduler_id, 1, 0, longValue, true, false));
        }
    }
}
