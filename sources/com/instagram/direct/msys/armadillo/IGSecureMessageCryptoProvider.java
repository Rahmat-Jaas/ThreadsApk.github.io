...
public class IGSecureMessageCryptoProvider {
    ...
    public static byte[] createCbcHmacEncryptedDataHandler(byte[] bArr, byte[] bArr2) {
        ...
        C10450iM.A03("msys_ig_create_cbc_hmac_encrypted_data", str);
        return null;
    }
    ...
    public static byte[] doHmacSHA256(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr2 == null) {
            C10450iM.A03("msys_ig_do_hmac_sha_256", "Given data is null.");
            return null;
        }
        Mac mac = getMac();
        if (bArr != null) {
            try {
                ...
                C10450iM.A07("msys_ig_do_hmac_sha_256", e);
                return null;
            }
        }
    ...
    public static byte[] getCiphertext(SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec, byte[] bArr) {
        try {
            ...
            C10450iM.A07("msys_ig_get_cipher_text", e);
            return null;
        }
    }
    ...
    public static byte[] getPlaintext(SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec, byte[] bArr) {
        try {
            ...
            C10450iM.A07("msys_ig_get_plain_text", e);
            return null;
        }
    }
            ...
            if (doHmacSHA256 != null) {
                ...
                while (i2 < ceil) {
                    ...
                    try {
                        ...
                        C10450iM.A07("msys_ig_create_sha_256_hkdf_data", e);
                ...
                C10450iM.A03("msys_ig_create_sha_256_hkdf_data", "copiedBytes did not come back with the correct size.");
                throw new AssertionError("copiedBytes did not come back with the correct size.");
            }
            C10450iM.A03("msys_ig_create_sha_256_hkdf_data", "hmac came back null.");
            throw new AssertionError("doHmacSHA256 returns null.");
        }
        C10450iM.A03("msys_ig_create_sha_256_hkdf_data", "Output size is too big.");
    ...
    public static Cipher getCipher(int i, SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec) {
        try {
            ...
            C10450iM.A07("msys_ig_get_cipher", e);
            throw new AssertionError(e);
        }
    }
    ...
    public static Mac getMac() {
        try {
            ...
            C10450iM.A07("msys_ig_get_mac", e);
            throw new AssertionError(e);
        }
    }
    ...
    public static byte[] getSHA256Hash(byte[] bArr) {
        try {
            ...
            C10450iM.A07("msys_ig_get_sha_256_hash", e);
            throw new AssertionError(e);
        }
    }
