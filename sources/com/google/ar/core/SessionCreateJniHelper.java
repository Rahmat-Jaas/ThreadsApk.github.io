...
public final class SessionCreateJniHelper {
    public static boolean checkApkSignature(Context context) {
        try {
            ...
            for (Signature signature2 : packageInfo.signatures) {
                ...
                Log.w("ARCore-SessionCreateJniHelper", C18180wK.A0i("'", sb));
            }
    ...
    public static int getMinApkVersion(Context context) {
        try {
            ...
            throw C18250wR.A0V("Application manifest must contain meta-data com.google.ar.core.min_apk_version");
