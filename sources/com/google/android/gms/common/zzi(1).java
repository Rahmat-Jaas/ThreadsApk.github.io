...
public abstract class zzi extends zzy {
    ...
    public final int DBz() {
        int A03 = C14030oh.A03(1987228838);
        int i = this.A00;
        C14030oh.A0A(-1907372095, A03);
        return i;
    }

    public final int hashCode() {
        int A03 = C14030oh.A03(1135222366);
        int i = this.A00;
        C14030oh.A0A(76681761, A03);
        return i;
    }
    ...
    public final IObjectWrapper DC2() {
        int A03 = C14030oh.A03(-1441306345);
        ObjectWrapper objectWrapper = new ObjectWrapper(A04());
        C14030oh.A0A(-1415798739, A03);
        return objectWrapper;
    }

    public final boolean equals(Object obj) {
        int i;
        int A03 = C14030oh.A03(-2092791988);
        if (obj == null || !(obj instanceof zzz)) {
            ...
            try {
                ...
                if (zzz.DBz() != this.A00) {
                    ...
                    IObjectWrapper DC2 = zzz.DC2();
                    if (DC2 == null) {
                        i = -403684751;
                    } else {
                        boolean equals = Arrays.equals(A04(), (byte[]) ObjectWrapper.A01(DC2));
                        C14030oh.A0A(217972620, A03);
                        return equals;
                    }
                }
            } catch (RemoteException e) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
                C14030oh.A0A(-1727924705, A03);
                return false;
            }
        }
        C14030oh.A0A(i, A03);
