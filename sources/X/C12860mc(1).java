...
public final class C12860mc {
    public static String A00(int i) {
        switch (i) {
            ...
            case 3375:
                return "OCULUS_SOCIAL_PLATFORM_PEOPLE_TABLET_MAIN_THREAD_FREE";
            case 3531:
            ...
            case 5930:
                return "OCULUS_SOCIAL_PLATFORM_PEOPLE_TABLET_LAUNCH_WITH_NETWORK";
            case 6051:
                return "OCULUS_SOCIAL_PLATFORM_COMMUNICATOR_THREAD_VIEW";
            case 6112:
                return "OCULUS_SOCIAL_PLATFORM_COMMUNICATOR_LAUNCH";
            case 7132:
                return "OCULUS_SOCIAL_PLATFORM_MESSENGER_CALL_START_OR_JOIN";
            case 7320:
            ...
            case 8330:
                return "OCULUS_SOCIAL_PLATFORM_PEOPLE_TABLET_LAUNCH";
            case 9573:
                return "OCULUS_SOCIAL_PLATFORM_RENDER_GROUP_VIEW";
            case 10238:
                return "OCULUS_SOCIAL_PLATFORM_AVATAR_STICKER_SEND";
            case 10343:
                return "OCULUS_SOCIAL_PLATFORM_AVATAR_STICKER_TRAY_OPEN";
            case 10916:
                return "OCULUS_SOCIAL_PLATFORM_LOAD_PARTY_INVITE_DIALOG_LIST";
            case 12277:
                return "OCULUS_SOCIAL_PLATFORM_MESSENGER_CALL_START";
            case 12397:
                return "OCULUS_SOCIAL_PLATFORM_AVATAR_CALLING_IMMERSIVE";
            case 12839:
                return "OCULUS_SOCIAL_PLATFORM_MESSENGER_VR_LAUNCH";
            case 13851:
                return "OCULUS_SOCIAL_PLATFORM_JOIN_PARTY";
            case 14441:
