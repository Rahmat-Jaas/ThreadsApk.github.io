    ...
    public static String A00(int i) {
        ...
        switch (i) {
            ...
            case HttpStatus.SC_ACCEPTED /*202*/:
                return "MESSENGER_MSYS_DB_MIGRATION";
            case HttpStatus.SC_NO_CONTENT /*204*/:
                return "MESSENGER_THREAD_SETTINGS_FRAGMENT_CREATE";
            case HttpStatus.SC_RESET_CONTENT /*205*/:
                return "MESSENGER_STARTUP_TTRC";
            case 208:
                return "MESSENGER_MSYS_SENDER_KEYS_MIGRATION";
            case 209:
            ...
            case 4988:
                return "MESSENGER_MISSING_LOCAL_CALL_ID";
            case 5758:
            ...
            case 6365:
                return "MESSENGER_MSYS_CONTACT_UPDATE";
            case 6590:
            ...
            case 8423:
                return "MESSENGER_MESSAGE_SEND_EXPERIENCE_V2";
            case 8868:
                return "MESSENGER_THREAD_LIST_LAYOUT";
            case 8907:
                return "MESSENGER_MESSAGE_SEND_EXPERIENCE_MSYS";
            case 9376:
                return "MESSENGER_THREADVIEW_OBSERVER";
            case 9391:
                return "MESSENGER_MESSENGER_COMPOSER_QPL_FUNNEL_TEST";
            case 9669:
                return "MESSENGER_CONTACTS_RENDER";
            case 9799:
                return "MESSENGER_THREAD_VIEW_DISPLAY_KEYBOARD";
            case 9932:
                return "MESSENGER_MESSAGE_SEND_EXPERIENCE_FULL";
            case 10095:
                return "MESSENGER_ACT_THREADLIST_TO_THREADVIEW";
            case 10127:
                return "MESSENGER_WC_THREAD_LIST_LAYOUT_TO_DRAW";
            case 10182:
                return "MESSENGER_RESTRICT_USER_QUERY_ANDROID";
            case 10647:
                return "MESSENGER_CHATD_CONNECT";
            case 11410:
                return "MESSENGER_THREAD_TRANSITION";
            case 11776:
                return "MESSENGER_PEOPLE_TRAY_DATA_LOAD";
            case 11910:
                return "MESSENGER_SEND_STATS";
            case 13341:
                return "MESSENGER_THREADLIST_TO_THREADVIEW_WITH_ANIMATION";
            case 13443:
                return "MESSENGER_PEOPLE_TRAY_LOAD";
            case 13659:
                return "MESSENGER_CHANNEL_JOINING";
            case 14081:
                return "MESSENGER_CHATD_DISCONNECT";
            case 14460:
                return "MESSENGER_THREAD_VIEW_DISPLAY_RATING_TRUST_SIGNAL";
            case 14531:
                return "MESSENGER_MSYS_ACCOUNT_SWITCH_LOGIN_COMPLETE";
            case 14985:
                return "MESSENGER_BACKGROUND_PUSH_EFFICIENCY";
            case 15123:
                return "MESSENGER_MSYS_ACCOUNT_SWITCH_START";
            case 15187:
                return "MESSENGER_MSYS_ACCOUNT_SWITCH_LOGOUT_COMPLETE";
            case 15418:
                return "MESSENGER_THREAD_VIEW_DISPLAY_ICEBREAKERS";
            case 15509:
                return "MESSENGER_CREATE_NEW_CHAT";
            case 15545:
                return "MESSENGER_THREAD_LIST_ON_LOAD_MORE_THREADS";
            case 15783:
                return "MESSENGER_ACT_MESSAGE_SEND_EXPERIENCE";
            case 15985:
                return "MESSENGER_MKI_THREADLIST_TO_THREADVIEW";
            case 16004:
