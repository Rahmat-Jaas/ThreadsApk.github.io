...
public final class C23681ez extends BusinessAttributeSyncBaseFragment {
    ...
    public final void onCreate(Bundle bundle) {
        int A02 = C14030oh.A02(1117391872);
        super.onCreate(bundle);
        this.A00 = C18190wL.A0S(this.mArguments);
        A01();
        C14030oh.A09(1587556391, A02);
    }

    public final void onViewCreated(View view, Bundle bundle) {
        String str;
        super.onViewCreated(view, bundle);
        AnonymousClass0wJ.A0L(view, R.id.subtitle).setText(2131821564);
        AnonymousClass0wJ.A0L(view, R.id.contact_review_header).setText(2131821563);
        ...
        A02(AnonymousClass0wJ.A0B(this).getString(2131821569));
        this.A00.setOnCheckedChangeListener(new IDxCListenerShape512S0100000_1_I2(this, 1));
    }
}
