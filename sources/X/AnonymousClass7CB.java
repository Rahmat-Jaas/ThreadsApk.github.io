...
public final class AnonymousClass7CB {
    public static AnonymousClass0YY A00 = AnonymousClass8M2.A00;
    ...
    public static final float A00(float[] fArr, float[] fArr2, int i, int i2) {
        int i3 = i << 2;
        return C86164wN.A03(fArr2, fArr[i3 + 3], C86164wN.A03(fArr2, fArr[i3 + 2], C86164wN.A03(fArr2, fArr[i3 + 1], fArr[i3] * fArr2[i2], i2 + 4), i2 + 8), i2 + 12);
    }
}
