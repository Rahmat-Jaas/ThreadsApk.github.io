...
public final class C124137aZ implements C147138nS {
    public final AnonymousClass587 A00;

    public C124137aZ(AnonymousClass587 r2) {
        C04220Ms.A0B(r2, 1);
        this.A00 = r2;
    }
    ...
    public final C62793ak create(Class cls) {
        C04220Ms.A0B(cls, 0);
        if (cls.isAssignableFrom(AnonymousClass574.class)) {
            return new AnonymousClass574(this.A00);
        }
