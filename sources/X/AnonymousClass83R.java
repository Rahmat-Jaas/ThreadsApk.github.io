...
public final class AnonymousClass83R implements Runnable, Choreographer.FrameCallback {
    public final /* synthetic */ AnonymousClass8bZ A00;

    public AnonymousClass83R(AnonymousClass8bZ r1) {
        this.A00 = r1;
    }
    ...
    public final void doFrame(long r6) {
        ...
        L_0x0035:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass83R.doFrame(long):void");
    }

    public final void run() {
        AnonymousClass8bZ r2 = this.A00;
        AnonymousClass8bZ.A02(r2);
        synchronized (r2.A08) {
            if (r2.A01.isEmpty()) {
