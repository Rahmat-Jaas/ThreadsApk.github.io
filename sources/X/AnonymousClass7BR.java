...
public final class AnonymousClass7BR {
    public static String A00(String str, int i, int i2) {
        ...
        return AnonymousClass6J2.A00(str2, A1b);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw new IndexOutOfBoundsException(AnonymousClass6J2.A00(str, objArr));
        }
    }
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 < 0 || i2 > i3) {
                    ...
                    str = AnonymousClass6J2.A00("end index (%s) must not be less than start index (%s)", C18210wN.A1Y(Integer.valueOf(i2), i));
                }
