...
public final class C121707Ho {
    ...
    public static C112416pY A01(File file) {
        int length;
        if (!file.exists() || A03(file)) {
            return new C112416pY(0, 0, 0);
        }
        if (!file.isDirectory()) {
            return A02(file, false);
        }
        C112416pY A02 = A02(file, true);
        File[] A04 = A04(file);
        if (A04 == null || (length = A04.length) == 0) {
            return A02;
        }
        ...
        long j3 = 1;
        do {
            C112416pY A01 = A01(A04[i]);
            j += A01.A00;
            j2 += A01.A02;
            j3 += A01.A01;
            i++;
        } while (i < length);
        return new C112416pY(j, j2, j3);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0062, code lost:
        X.AnonymousClass0JV.A04("BigFoot", "The lstat method failed to return a valid response", r1);
     */
    ...
    public static X.C112416pY A02(java.io.File r13, boolean r14) {
        /*
            long r9 = r13.length()
        ...
        L_0x0061:
            ...
            X.AnonymousClass0JV.A04(r4, r0, r1)
        L_0x0067:
        ...
        L_0x007b:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C121707Ho.A02(java.io.File, boolean):X.6pY");
    }

    public static boolean A03(File file) {
        try {
            if (file.getParent() != null) {
                file = C86154wM.A0U(file.getParentFile().getCanonicalFile(), file.getName());
            }
    ...
    public static File[] A04(File file) {
        ...
        try {
            ...
            AnonymousClass0JV.A05("BigFoot", AnonymousClass00U.A0L("The path is invalid: ", file.getAbsolutePath()), e);
            return null;
        }
    }
}
