...
public final class AnonymousClass7Fe {
    public static final void A01(View view, int i) {
        ViewGroup.MarginLayoutParams marginLayoutParams;
        C04220Ms.A0B(view, 0);
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(i, C29934Fwk.A0h);
    ...
    public static final void A03(View view, float[] fArr, int i, int i2, int i3, int i4) {
        ...
        gradientDrawable2.setColor(AnonymousClass7Kz.A00(context, i2));
        gradientDrawable2.setCornerRadii(fArr);
        GradientDrawable gradientDrawable3 = new GradientDrawable();
        gradientDrawable3.setColor(AnonymousClass7Kz.A00(context, i3));
        gradientDrawable3.setCornerRadii(fArr);
        GradientDrawable gradientDrawable4 = new GradientDrawable();
        gradientDrawable4.setColor(AnonymousClass7Kz.A00(context, i4));
    ...
    public static final void A02(View view, int i) {
        view.setBackgroundColor(AnonymousClass7Kz.A0G().A03(view.getContext(), i));
    }
}
