...
public final class AnonymousClass7BQ {
    ...
    public static String A00(String str, String str2) {
        ...
        int[] A022 = A02(str);
        if (A02[3] == 0) {
            A0r.append(str, 0, A022[3]);
            return C18180wK.A0i(str2, A0r);
        } else if (A02[2] == 0) {
            A0r.append(str, 0, A022[2]);
            return C18180wK.A0i(str2, A0r);
        } else {
            int i = A02[1];
            if (i != 0) {
                ...
                A0r.append(str, 0, i2);
                A0r.append(str2);
                return A01(A0r, A02[1] + i2, i2 + A02[2]);
            } else if (str2.charAt(i) == '/') {
                A0r.append(str, 0, A022[1]);
                A0r.append(str2);
                int i3 = A022[1];
                return A01(A0r, i3, A02[2] + i3);
            } else {
                int i4 = A022[0] + 2;
                int i5 = A022[1];
                if (i4 >= i5 || i5 != A022[2]) {
                    ...
                    A0r.append(str, 0, i6);
                    A0r.append(str2);
                    return A01(A0r, A022[1], i6 + A02[2]);
                }
                A0r.append(str, 0, i5);
                A0r.append('/');
                A0r.append(str2);
                int i7 = A022[1];
                return A01(A0r, i7, A02[2] + i7 + 1);
            }
        }
    }
}
