...
public final class AnonymousClass7DW {
    public Object A00;
    public boolean A01;
    public final C147368pE A02;
    public final C147368pE A03;

    public static final void A00(AnonymousClass7DW r2, int i, int i2) {
        if (((float) i) >= BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) {
            C147368pE r1 = r2.A02;
            if (i != ((C114106sh) r1.getValue()).A00) {
                r1.CrC(new C114106sh(i));
            }
    ...
    public AnonymousClass7DW(int i, int i2) {
        C114106sh r0 = new C114106sh(i);
