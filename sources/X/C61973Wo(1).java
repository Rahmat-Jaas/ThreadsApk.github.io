...
public final class C61973Wo {
    ...
    public static String A01(int i, int i2, int i3) {
        ...
        int i4 = 0;
        while (i4 < A1W.length) {
            i4 = C18250wR.A02(A1W, (A1W[i4] - i3) - 84, i4);
        }
        return C18250wR.A0b(A1W);
    }

    public static Intent A00(Context context, String str, String str2) {
        String obj = C15430rJ.A01(str).buildUpon().appendQueryParameter(A01(174, 10, 9), str2).build().toString();
