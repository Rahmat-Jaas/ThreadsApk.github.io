        ...
        if ("android.intent.action.SEND".equals(action)) {
            try {
                ...
                if (!(uri3 == null && charSequenceExtra == null && stringExtra == null)) {
                    parseUri.setClipData(new ClipData((CharSequence) null, new String[]{parseUri.getType()}, new ClipData.Item(charSequenceExtra, stringExtra, (Intent) null, uri3)));
                    return parseUri;
                }
            ...
            if (i > 0) {
                ...
                ClipData clipData = new ClipData((CharSequence) null, strArr, new ClipData.Item(charSequence, str2, (Intent) null, uri));
