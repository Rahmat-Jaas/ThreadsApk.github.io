...
public final class C71574Ji implements C0N {
    ...
    public final C27828Etx BHO(Context context, BKH bkh, C19589Ayp ayp, UserSession userSession) {
        return new C26431qd((CharSequence) context.getString(2131836291));
    }

    public final void CPT(C11630kW r4, BKH bkh, C19589Ayp ayp, UserSession userSession) {
        AnonymousClass0wJ.A13(C28161tl.A02(AnonymousClass3WS.A01(userSession)), "story_to_reel_has_seen_tooltip", true);
    }

    public final boolean Ct9(BKH bkh, C19589Ayp ayp, C1525190h r5, UserSession userSession) {
        if (r5.A06() == null || C18190wL.A1X(C28161tl.A04(userSession), "story_to_reel_has_seen_tooltip")) {
            return false;
        }
        return true;
    }
