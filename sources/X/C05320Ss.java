...
public final class C05320Ss extends SparseArray {
    public C05320Ss() {
        put(0, "/buddy_list");
        put(1, "/create_thread");
        ...
        put(34, RealtimeConstants.MQTT_TOPIC_PREEMPTIVE_PING);
        ...
        put(87, "/v_ios");
        put(88, RealtimeConstants.MQTT_TOPIC_SKYWALKER);
        put(89, "/get_media");
        ...
        put(96, "/t_sm_b_rsp");
        put(97, "/t_ms_gd");
        put(98, RealtimeConstants.MQTT_TOPIC_RTC_MULTI);
        put(99, "/friend_accepted");
        put(100, "/t_tn");
        put(HttpStatus.SC_SWITCHING_PROTOCOLS, "/t_mf_as");
        put(HttpStatus.SC_PROCESSING, "/t_fs");
        put(103, "/t_tp");
        put(104, "/t_stp");
        put(105, "/t_st");
        put(106, "/omni");
        ...
        put(125, "/p_a_resp");
        put(126, "/unsubscribe");
        put(StringTreeSet.MAX_SYMBOL_COUNT, "/t_graphql_req");
        put(128, "/t_graphql_resp");
        put(129, "/t_app_update");
        put(130, "/p_updated");
        put(131, "/t_omnistore_sync_low_pri");
        put(132, RealtimeConstants.MQTT_TOPIC_SEND_MESSAGE);
        put(133, RealtimeConstants.MQTT_TOPIC_SEND_MESSAGE_RESPONSE);
        put(134, RealtimeConstants.MQTT_TOPIC_SUB_IRIS);
        put(135, RealtimeConstants.MQTT_TOPIC_SUB_IRIS_RESPONSE);
        ...
        put(146, RealtimeConstants.MQTT_TOPIC_MESSAGE_SYNC);
        put(148, "/t_omnistore_batched_message");
        put(149, RealtimeConstants.MQTT_TOPIC_REALTIME_META_SUBSCRIBE);
        put(150, RealtimeConstants.MQTT_TOPIC_REGION_HINT);
        ...
        put(178, "/ls_req");
        put(179, RealtimeConstants.MQTT_TOPIC_LS_RESPONSE);
        ...
        put(HttpStatus.SC_CREATED, "/video_rt_pipe");
        put(HttpStatus.SC_ACCEPTED, "/t_update_presence_extra_data");
        put(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, "/video_rt_pipe_res");
        put(HttpStatus.SC_NO_CONTENT, "/t_token_feedback");
        put(HttpStatus.SC_RESET_CONTENT, "/ai_demos_server_model_zoo");
        put(211, "/onevc");
        ...
        put(248, "/messenger_sync_unsubscribe_queue");
        put(250, "/generative_group_ranking_send_updated_scores");
        put(253, "/rtc_ringback");
        put(254, "/rtc_ringback_req");
        put(255, "/workplace_desks");
        put(256, "/t_rtc_multi_proxy");
        ...
        put(268, "/t_contextual_presence_subscription");
        put(270, "/launch_media_on_portal");
        put(273, "/t_trace");
        put(274, RealtimeConstants.MQTT_TOPIC_RTC_ON_DEMAND_LOG);
        put(275, "/t_disable_rtc_multi_topic_auto_subscription");
        put(279, RealtimeConstants.MQTT_TOPIC_LARGE_SCALE_SYNC);
    }
}
