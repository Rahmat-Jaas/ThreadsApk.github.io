...
public final class C134557xt implements C39818L1p {
    ...
    public final boolean CsC(UserSession userSession) {
        if (!C63803iN.A0E(C18180wK.A0J(userSession), userSession, 36323689473515523L) || C18190wL.A07() < C18180wK.A05(C28161tl.A04(userSession), I17.A00(48))) {
            return false;
        }
        return true;
    }
