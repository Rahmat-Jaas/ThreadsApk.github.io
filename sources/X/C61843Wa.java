...
public final class C61843Wa {
    public static final GQLCallInputCInputShape0S0000000 A00(Context context, String str) {
        ...
        if (context == null || !C09650fs.A03(context)) {
            z = false;
        }
        GraphQlCallInput.A05(A00, Boolean.valueOf(z), "is_fb_app_installed");
        GraphQlCallInput.A05(A00, str, "client_session_id");
        return A00;
    }

    public static final String A01(AnonymousClass2AC r1) {
        switch (r1.ordinal()) {
            case 0:
    ...
    public static final String A02(AnonymousClass2AD r0) {
        switch (r0.ordinal()) {
            case 0:
