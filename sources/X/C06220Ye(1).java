...
public final class C06220Ye {
    public static String A00(int i) {
        if (i == 7868) {
            return "AR_DELIVERY_DESTROY_AUGMENT_SEED_GROUP";
        }
        if (i == 7869) {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case 2292:
                        return "AR_DELIVERY_MULTIPEER_SEND_BINARY_MESSAGE";
                    case 3697:
                    ...
                    case 8260:
                        return "AR_DELIVERY_MULTIPEER_RECEIVE_BINARY_MESSAGE";
                    case 8455:
                    ...
                    case 12031:
                        return "AR_DELIVERY_MULTIPEER_GET_BINARY_MESSAGE_STREAM";
                    case 13817:
                        return "AR_DELIVERY_SPARK_PERSISTENCE_WRITE";
                    case 14437:
                        return "AR_DELIVERY_MULTIPEER_GET_MESSAGE_STREAM";
                    case 14510:
