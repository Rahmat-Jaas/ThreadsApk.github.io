                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            case 1426:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_TOTAL_SWAP";
                            case 1456:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_NATIVE_HEAP";
                            case 2117:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_JAVA_HEAP";
                            case 2476:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_PRIVATE_OTHER";
                            case 7041:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_GRAPHICS";
                            case 7528:
                                return "PROC_AND_PERF_MAPPING_DMABUF";
                            case 7964:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_STACK";
                            case 8228:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_CODE";
                            case 11155:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_TOTAL_PSS";
                            case 11476:
                                return "PROC_AND_PERF_MAPPING_GL_DEV";
                            case 12281:
                                return "PROC_AND_PERF_MEMORY_MEMTRACK_GL_PSS";
                            case 12699:
                                return "PROC_AND_PERF_MEMORY_MEMTRACK_OTHER_PSS";
                            case 13931:
                                return "PROC_AND_PERF_MEMORY_SUMMARY_SYSTEM";
                            case 14968:
                                return "PROC_AND_PERF_MEMORY_MEMTRACK_GRAPHICS_PSS";
                            default:
                                switch (i) {
                                    case 35:
                                        ...
                                        switch (i) {
                                            ...
                                            default:
                                                switch (i) {
                                                    ...
                                                    case 57:
                                                        return "PROC_AND_PERF_THREAD_SYSTEM_TIME";
                                                    case 58:
